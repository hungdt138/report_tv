...
public class AdvertisingBean {
    ...
    public AdvertisingBean(int advertisingId, String content,
            String createdDate, String createdTime, int webUserId,
            boolean isDisplay, int partnerId, String startDate, String endDate,
            String startTime, String endTime, int totalPage, int totalRecord,
