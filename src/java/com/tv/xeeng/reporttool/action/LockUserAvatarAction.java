...
public class LockUserAvatarAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (request.getParameter("userId") != null) {
            int userId = Integer.parseInt(request.getParameter("userId"));
                ...
                boolean success = new WorkingUserDAO().lockUserAvatar(userId, loggedInUser);
//                if (success) {
...
//                } else {
//                    request.setAttribute("msg_notifi", "Khóa không thành công hoặc người chơi không có avatar.");
