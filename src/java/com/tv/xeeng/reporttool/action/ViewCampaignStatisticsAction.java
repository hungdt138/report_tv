...
import com.tv.xeeng.reporttool.beans.CampaignStatistics;
...
public class ViewCampaignStatisticsAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        List<CampaignStatistics> stat = LogDAO.getCampaignStatistics(dateStart, dateEnd);
