...
<script>
    ...
    function doDetail(partnerId,fromDate,toDate) {
        ...
        document.getElementById('sfromDate').value = fromDate;
        document.getElementById('stoDate').value = toDate;
        obj.submit();
        return true;
    }
    function doReport() {
...
<tr>
    <td align="center">
        <h:form action="reportbypartner.html?action=report" method="post" styleId="form">
        ...
        <c:if test="${requestScope.report != null}" >               
                <tr bgcolor="#E5E9F0">
                    <td width="5%" align="center">Partner</td>
                    <td width="10%" align="center">Tổng thẻ</td>
                    <td width="10%" align="center">VND(Card)</td>
                    <td width="15%" align="center">Tổng SMS</td>
                    <td width="10%" align="center">VND(SMS)</td>
                ...
                <c:forEach items="${requestScope.report}"  var="record">    
                    ...
                    <tr>                        
                        <td align="center">
                            <c:out value="${record.partnerName} (${record.partnerId})" />
                        </td>                                                   
                        <td align="center">
                        ...
                        <td align="center">  
                            <a  href='#' onclick='doDetail(${record.partnerId},"${requestScope.fromDate}","${requestScope.toDate}");'>Chi tiết</a>
                        </td>
                    </tr>                                  
                </c:forEach>
