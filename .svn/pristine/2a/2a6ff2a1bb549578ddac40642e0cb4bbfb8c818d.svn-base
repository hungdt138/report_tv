...
<ul class="sidebar-menu">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="listReportUser.html?page=1&menuItem=listac"><i class="fa fa-angle-double-right"></i> Danh sách</a></li>
            <li><a href="add_report_user.jsp?menuItem=addacc"><i class="fa fa-angle-double-right"></i> Tạo mới</a></li>
            <li><a href="view_report_user_log.html"><i class="fa fa-angle-double-right"></i> Nhật ký hoạt động</a></li>
        </ul>
    </li>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="view_modify_money_log.html"><i class="fa fa-angle-double-right"></i> Thay đổi bằng Tool</a></li>
            <li><a href="view_money_charging_log.html"><i class="fa fa-angle-double-right"></i> Nạp tiền</a></li>
        </ul>
    </li>
    <li class="treeview">
        <a href="#">
            <i class="fa  fa-money"></i> <span>Quản lý Event</span>
            <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
