...
import com.tv.xeeng.reporttool.beans.ChargingDailyStatistics;
...
public class ViewChargingStatistics extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        List<ChargingDailyStatistics> stat = LogDAO.getChargingStatistics(dateStart, dateEnd);
