var pathToImages = 'res/img/';	// Relative to your HTML file
var turnOffYearSpan = false;     // true = Only show This Year and Next, false = show +/- 5 years
var weekStartsOnSunday = false;  // true = Start the week on Sunday, false = start the week on Monday
var showWeekNumber = true;  // true = show week number,  false = do not show week number


var languageCode = getCookie('SELECTED_LANGUAGE');	// Possible values: 	en,ge,no,nl,es,pt-br,fr,vn
if (languageCode == "" || languageCode == 'vi') {
    languageCode = 'vn'
}
...
switch (languageCode) {
    ...
    case "vn":	/* Vietnamese */
        ...
        var monthArrayShort = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
        var dayArray = ['T2', 'T3', 'T4', 'T5', 'T6', 'T7', 'CN'];
        var weekString = 'Tu\u1ea7n';
        var todayString = 'H\u00f4m nay';
        break;
        /*case "vn":	
         var monthArray = ['Th\u00e1ng Gi\u00eang','Th\u00e1ng Hai','Th\u00e1ng Ba','Th\u00e1ng  T\u01b0','Th\u00e1ng N\u0103m','Th\u00e1ng S\u00e1u','Th\u00e1ng B\u1ea3y','Th\u00e1ng T\u00e1m','Th\u00e1ng Ch\u00edn','Th\u00e1ng M\u01b0\u1eddi','Th\u00e1ng M\u01b0\u1eddi M\u1ed9t','Th\u00e1ng M\u01b0\u1eddi Hai'];
         var monthArrayShort = ['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'];
         var dayArray = ['Th\u1ee9 Hai','Th\u1ee9 Ba','Th\u1ee9 T\u01b0','Th\u1ee9 N\u0103m','Th\u1ee9 S\u00e1u','Th\u1ee9 B\u1ea3y','Ch\u1ee7 Nh\u1eadt'];
         var weekString = 'Tu\u1ea7n';
         var todayString = 'H\u00f4m nay';
         break;
         */
...
function initCalendar()
{
    if (MSIE) {
        ...
        // Fix or create error? --> Duyvv comment this code to fix error on IE
        // fix for EI frame problem on time dropdowns 09/30/2006
...
function validate_compareDate(fromDate, toDate)
{
...
function validate_DateReport(validateday)
{
// validateday = validateday.trim();
// Fomat: dd/MM/yyyy	
    if (validateday == null || validateday == '') {
        return false;
    }
    if (validateday.length > 10 || validateday.length < 8) {
        return false;
    }

    var pos1 = validateday.indexOf('/');
    if (pos1 < 0) {
        return false;
    }
    var pos2 = validateday.indexOf('/', pos1 + 1);
    if (pos2 < 0) {
        return false;
    }
    var pos3 = validateday.indexOf('/', pos2 + 1);
    if (pos3 > 0) {
        return false;
    }

    var dd = validateday.substring(0, pos1);
    var mm = validateday.substring(pos1 + 1, pos2);
    var yy = validateday.substring(pos2 + 1);
    ...
    if (dd < '01' || dd > '31' || mm < '01' || mm > '12' || yy < '1900') {
        return false;
    }

    var patten = '0123456789';
    for (i = 0; i < date.length; i++) {
        if (patten.indexOf(date.charAt(i)) < 0) {
            return false;
        }
    }
    return true;
