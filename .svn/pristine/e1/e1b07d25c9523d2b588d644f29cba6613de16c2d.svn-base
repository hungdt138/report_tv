...
public class ViewExchangeLogAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        int numOfXeeng = BlahBlahUtil.parseInt(request.getParameter("numOfXeeng"), -1);

        List<ExchangeLog> logs = LogDAO.getAllExchangeLog(pageC, loginName, numOfXeeng);
        int numOfRecord = LogDAO.getNumOfExchangeLog(loginName, numOfXeeng);
