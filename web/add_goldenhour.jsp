...
<tr style="width: 100%">
	<td align="center" style="border-color: green;">
		...
		<div
			...
			<html:form action="addGoldenhour.html" method="post">
				<table >				
					<tr>
						<td style="width: 200px">
							<div style="float: left;">Thời gian bắt đầu:</div>
						</td>
						<td>
							<html:text styleId="fromDate" maxlength="16" property="fromDate" readonly="true" value='${requestScope.fromDate}' size="16"/>
					...
					<tr style="margin-top: 15px">
						<td>
							<div style="float: left; width: 100%">Thời gian kết thúc</div>
							<div style="float: left;clear:both; width: 100%"></div>	
						</td>
						<td>
							<html:text styleId="tDate" maxlength="16" property="toDate" readonly="true" value='${requestScope.fromDate}' size="16"/>
					...
					<tr>
						<td>Tiền thưởng</td>
						<td><html:text property="bonusAmount" value=""/> </td>
						<td></td>
					</tr>
					<tr>
						<td>Đối tác</td>
					...
					<tr>
						<td>Số lần</td>
						<td><html:text property="externalParam" value=""/> </td>
						<td></td>
					</tr>
					<tr>
						<td>Mô tả</td>
						<td><html:textarea style="width:400px; height: 50px" property="description" value=""/> </td>
						<td></td>
					</tr>
